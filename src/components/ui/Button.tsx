  ...
  return (
    <button
      className={cn(
        ...
        {
          'bg-purple-600 text-white hover:bg-purple-700 focus:ring-purple-500 shadow-sm hover:shadow-md dark:bg-purple-600 dark:hover:bg-purple-700': variant === 'primary',
